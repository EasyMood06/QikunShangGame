namespace GameCreator.Camera
{
    ...
    public class CameraMotorTypeAdventure : ICameraMotorType
    {
        ...
        {
            get => Mathf.InverseLerp(this.zoomLimits.x, this.zoomLimits.y, this.currentZoom);
            set => this.desiredZoom = Mathf.Lerp(this.zoomLimits.x, this.zoomLimits.y, value);
        }
        ...
        public void AddRotation(float pitch, float yaw, float roll = 0f)
        {
